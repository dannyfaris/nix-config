...
> **Forward note (2026-07-07):** this review's prioritisation is partially superseded by same-week decisions — #558 resolved (→ ADR-042; SSH CA and Tailscale SSH declined), #570 rejected (work/personal boundary, residual accepted), #568 deferred (trust tiers gated on the deferred auto-merge decision), #526 and #387 now designed (see [docs/design/](../design/)). The structural observations (the metis capacity hub, #526 as key-custody keystone, #551 as most-depended-upon) stand; the wave / top-five sequencing should be read against those decisions and the [record-coherence sweep](./record-coherence-sweep-2026-07-07.md).
