...
| [utm.md](./utm.md)                                         | **Retired from the fleet (#726)** — `pkgs.utm` dropped from both Macs; UTM had hosted nixos-vm (decommissioned #634) on neptune and the operator's own VMs on saturn. Retained as the selection record                                                   | #11    |
