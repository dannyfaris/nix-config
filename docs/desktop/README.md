...
| [polkit.md](./polkit.md)                   | Graphical authentication agent — mate-polkit (GTK3, base16-themed), the session's only one since niri ships none; no Stylix `qt` target, as nothing Qt remains to theme                                                                                   | #103           |
...
| [screen-sharing.md](./screen-sharing.md)   | Screencast backend — keep the niri module's `xdg-desktop-portal-gnome` driving niri's native `Mutter.ScreenCast` over PipeWire (wiring verified present; RemoteDesktop unsupported upstream)                                                              | #101           |
