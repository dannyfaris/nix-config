...
- ✗ **The desktop's rendered surfaces lose Stylix's curated base16 theming and the hybrid mono/sans typography** — Noctalia's bundled Rose Pine + Material-3 type system replace them. (Under E1 the base16 palette + #331 slot corrections survive as a static colour table for the TUI statuslines; full literal removal is the deferred E2.) Accepted by the operator for the desktop.
