---
date: 2026-06-24
status: Accepted, Implementation pending; **§7 (macOS window-management realization) superseded by [ADR-040](./ADR-040-macos-window-manager-aerospace.md)** (itself superseded by [ADR-047](./ADR-047-macos-window-manager-yabai.md) — yabai + skhd) — the registry architecture (§1–6, §8–9) stands
---
