...
Configured in `modules/home/direnv.nix`:
...
Home-manager package list at `modules/home/cli-utils.nix` and
`modules/home/nix-tooling.nix` should stay minimal: only tools wanted
