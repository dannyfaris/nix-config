...
# which is already on PATH via home/core/shared/agent-clis.nix).
#
# Wayland-native rendering is handled host-wide by
# modules/core/nixos/electron-wayland.nix (sets NIXOS_OZONE_WL=1);
...
# whitelisted in modules/core/nixos/nix-daemon.nix's
...
# when home/core/darwin/ lands per the mac-mini onboarding epic #11.
#
