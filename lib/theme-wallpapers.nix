...
#
# Pure data, the theme-families.nix pattern: no pkgs here; the consuming
...
# theme-families.nix trades in), not theme x polarity: polarity is just
# which scheme of the couplet is active, and a named-theme family entry
# is a couplet of scheme names — this flat keying survives both stages
# unchanged. See docs/design/macos-live-theme-switching.md §Design.
#
