...
in
{
  ...
  flake.packages.x86_64-linux.checks-without-hosts = mkChecksWithoutHosts "x86_64-linux";
  flake.packages.aarch64-linux.checks-without-hosts = mkChecksWithoutHosts "aarch64-linux";
  flake.packages.aarch64-darwin.checks-without-hosts = mkChecksWithoutHosts "aarch64-darwin";
